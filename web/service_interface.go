...
type ServiceInterface interface {
	...
	confirmInvitationForm(w http.ResponseWriter, r *http.Request)
	confirmInvitation(w http.ResponseWriter, r *http.Request)
	confirmInvitationSuccess(w http.ResponseWriter, r *http.Request)
